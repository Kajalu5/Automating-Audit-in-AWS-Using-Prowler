...
The command to install prowler is: sudo bash, adduser prowler, su prowler, python3 -m pip install --user pipx, python3 -m pipx ensurepath, pipx install prowler, cd /tmp, prowler aws
